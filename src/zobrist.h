...
const int hash_piece[12] = {1, 3, 5, 7, 9, 11, 0, 2, 4, 6, 8, 10};

const U64 castlingKey[16] = {0,
                            RANDOM_ARRAY[768], // WK
                            RANDOM_ARRAY[768 + 1], // WQ
                            RANDOM_ARRAY[768] ^ RANDOM_ARRAY[768 + 1], // WK WQ
                            RANDOM_ARRAY[768 + 2], // BK
                            RANDOM_ARRAY[768] ^ RANDOM_ARRAY[768 + 2], // WK BK
                            RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 2], // WQ NK
                            RANDOM_ARRAY[768] ^ RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 2], // WK WQ BK
                            RANDOM_ARRAY[768 + 3], // BQ
                            RANDOM_ARRAY[768] ^ RANDOM_ARRAY[768 + 3], // WK BQ
                            RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 3], // WQ BQ
                            RANDOM_ARRAY[768] ^ RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 3], // WK WQ BQ
                            RANDOM_ARRAY[768 + 3] ^ RANDOM_ARRAY[768 + 2], // BK BQ
                            RANDOM_ARRAY[768 + 3] ^ RANDOM_ARRAY[768 + 2] ^ RANDOM_ARRAY[768], // WK BK BQ
                            RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 2] ^ RANDOM_ARRAY[768 + 3], // WQ BK BQ
                            RANDOM_ARRAY[768 + 1] ^ RANDOM_ARRAY[768 + 2] ^ RANDOM_ARRAY[768 + 3] ^ RANDOM_ARRAY[768]}; // WK WQ BK BQ